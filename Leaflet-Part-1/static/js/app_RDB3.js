...
//Looping through quake array, and create marker for each quake
//for (let i = 0; i < data.features; i++) {

  //Conditionals for quake magnitude
  //let color = "";
  //if (data.feature[i].mag > 5) {
    //color = "yellow";
  //}
  //else if (data.feature[i].mag > 4) {
    //color = "blue";
  //else if (data.feature[i].mag > 3) {
    //color = "green";
  //}
  //else {
    //color = "violet";
...
//L.circle(data.feature[i].place, {
  //fillOpacity: 0.75,
  //color: "white",
  //fillColor: color,
  //Adjust the radius
  //radius: Math.sqrt(data.feature[i].mag) * 5000
//}).bindPopup(`<h1>${data.feature[i].place}</h1><hr><h3>PlaceTest: ${data.feature[i].mag}</h3>`).addTo(myMap);
//}
